...
#ifndef REMOTELOGLIBRARY_SWIFT_H
#define REMOTELOGLIBRARY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="RemoteLogLibrary",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16RemoteLogLibrary11RemoteEvent")
@interface RemoteEvent : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC16RemoteLogLibrary18NetworkRemoteEvent")
@interface NetworkRemoteEvent : RemoteEvent
@end
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
- (void)notificationSend:(NSNotification * _Nonnull)notification;
@end



/// A wrapper around Starscream’s SSLSecurity that provides a minimal Objective-C interface.
SWIFT_CLASS("_TtC16RemoteLogLibrary11SSLSecurity")
...
SWIFT_PROTOCOL("_TtP16RemoteLogLibrary17SocketManagerSpec_")
...
SWIFT_CLASS("_TtC16RemoteLogLibrary13SocketManager")
...
///
/// \endcode
SWIFT_CLASS("_TtC16RemoteLogLibrary16SocketRawAckView")
...
///
/// \endcode
SWIFT_CLASS("_TtC16RemoteLogLibrary13SocketRawView")
...
SWIFT_CLASS("_TtC16RemoteLogLibrary13UIRemoteEvent")
@interface UIRemoteEvent : RemoteEvent
@end
