...
@interface NSArray (SWIFT_EXTENSION(RemoteLogLibrary))
@end


@interface NSData (SWIFT_EXTENSION(RemoteLogLibrary))
@end


@interface NSDictionary (SWIFT_EXTENSION(RemoteLogLibrary))
@end
...
@interface NSMutableURLRequest (SWIFT_EXTENSION(RemoteLogLibrary))
@end


@interface NSNull (SWIFT_EXTENSION(RemoteLogLibrary))
@end


@interface NSString (SWIFT_EXTENSION(RemoteLogLibrary))
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nullable key;)
+ (NSString * _Nullable)key SWIFT_WARN_UNUSED_RESULT;
+ (void)setKey:(NSString * _Nullable)value;
...
+ (void)loadWithStart:(BOOL)start;
+ (void)remoteEvent:(NSNotification * _Nonnull)notification;
+ (void)start;
+ (void)stop;
+ (void)networkWithSession:(NSURLSessionConfiguration * _Nonnull)session;
